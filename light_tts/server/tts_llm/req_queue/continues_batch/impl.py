...
from light_tts.server.tts_llm.batch import Batch, Req
from light_tts.server.tts_llm.req_queue.base_queue import BaseQueue
...
class ContinuesBatchQueue(BaseQueue):
    ...
    def generate_new_batch(self, current_batch: Batch, limit_router_queue_length: int = None):
        ...
        for req in waiting_queue:
            ...
            if ok_insert:
                logger.debug(f"req {req.request_id} can be added to batch")
